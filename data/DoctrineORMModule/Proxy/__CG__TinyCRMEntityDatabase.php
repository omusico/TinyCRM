 ...
 */
class Database extends \TinyCRM\Entity\Database implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', '' . "\0" . 'TinyCRM\\Entity\\Database' . "\0" . 'contacts', 'createdAt', 'createdBy');
        }
